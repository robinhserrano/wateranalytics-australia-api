...
*/
export const addMember = (args: { team: string | number | { id: string | number } } | [team: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/teams/{team}/members'
*/
addMember.url = (args: { team: string | number | { id: string | number } } | [team: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { team: args }
    }
...
* @route '/teams/{team}/members'
*/
addMember.post = (args: { team: string | number | { id: string | number } } | [team: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addMember.url(args, options),
    method: 'post',
})
...
* @route '/teams/{team}/members'
*/
const addMemberForm = (args: { team: string | number | { id: string | number } } | [team: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/teams/{team}/members'
*/
addMemberForm.post = (args: { team: string | number | { id: string | number } } | [team: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: addMember.url(args, options),
    method: 'post',
})
...
*/
export const removeMember = (args: { team: string | number | { id: string | number }, user: string | number | { id: string | number } } | [team: string | number | { id: string | number }, user: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/teams/{team}/members/{user}'
*/
removeMember.url = (args: { team: string | number | { id: string | number }, user: string | number | { id: string | number } } | [team: string | number | { id: string | number }, user: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            team: args[0],
            user: args[1],
...
* @route '/teams/{team}/members/{user}'
*/
removeMember.delete = (args: { team: string | number | { id: string | number }, user: string | number | { id: string | number } } | [team: string | number | { id: string | number }, user: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: removeMember.url(args, options),
    method: 'delete',
})
...
* @route '/teams/{team}/members/{user}'
*/
const removeMemberForm = (args: { team: string | number | { id: string | number }, user: string | number | { id: string | number } } | [team: string | number | { id: string | number }, user: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/teams/{team}/members/{user}'
*/
removeMemberForm.delete = (args: { team: string | number | { id: string | number }, user: string | number | { id: string | number } } | [team: string | number | { id: string | number }, user: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: removeMember.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const TeamController = { index, create, store, show, edit, update, destroy, addMember, removeMember }
