...
* @route '/livewire-ed2157db/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-ed2157db/livewire.js',
...
* @route '/livewire-ed2157db/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-ed2157db/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-ed2157db/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-ed2157db/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
