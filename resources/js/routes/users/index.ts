...
/**
* @see \App\Http\Controllers\CommissionController::commissionStats
* @see app/Http/Controllers/CommissionController.php:475
* @route '/users/{user}/commission-stats'
*/
export const commissionStats = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: commissionStats.url(args, options),
    method: 'get',
})

commissionStats.definition = {
    methods: ["get","head"],
...
* @route '/users/{user}/commission-stats'
*/
commissionStats.url = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return commissionStats.definition.url
...
* @route '/users/{user}/commission-stats'
*/
commissionStats.get = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: commissionStats.url(args, options),
    method: 'get',
})
...
* @route '/users/{user}/commission-stats'
*/
commissionStats.head = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: commissionStats.url(args, options),
    method: 'head',
})
...
* @route '/users/{user}/commission-stats'
*/
const commissionStatsForm = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: commissionStats.url(args, options),
    method: 'get',
})
...
* @route '/users/{user}/commission-stats'
*/
commissionStatsForm.get = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: commissionStats.url(args, options),
    method: 'get',
})
...
* @route '/users/{user}/commission-stats'
*/
commissionStatsForm.head = (args: { user: string | number } | [user: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: commissionStats.url(args, {
...
commissionStats.form = commissionStatsForm
...
* @see app/Http/Controllers/UserController.php:129
...
* @see app/Http/Controllers/UserController.php:205
* @route '/users/{user}'
*/
...
const users = {
    commissionStats: Object.assign(commissionStats, commissionStats),
